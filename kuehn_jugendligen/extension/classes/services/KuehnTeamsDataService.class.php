...
public static function getJugendTeamsOfLeagueOrderedByTableCriteria(WebSoccer $websoccer, DbConnection $db, $leagueId) {
// get current season
$result = $db->querySelect('id', $websoccer->getConfig('db_prefix') .'_saison',
'liga_id = %d AND beendet = \'0\' ORDER BY name DESC', $leagueId, 1);
$season = $result->fetch_array();
...
$columns['C.id'] = 'id';
$columns['C.name'] = 'name';
$columns['C.ju_sa_punkte'] = 'score';
$columns['C.ju_sa_tore'] = 'goals';
$columns['C.ju_sa_gegentore'] = 'goals_received';
$columns['(C.ju_sa_tore - C.ju_sa_gegentore)'] = 'goals_diff';
$columns['C.ju_sa_siege'] = 'wins';
$columns['C.ju_sa_niederlagen'] = 'defeats';
$columns['C.ju_sa_unentschieden'] = 'draws';
$columns['C.ju_sa_spiele'] = 'matches';
$columns['C.bild'] = 'picture';
$columns['U.id'] = 'user_id';
$columns['U.nick'] = 'user_name';
$columns['U.email'] = 'user_email';
...
// order by
$whereCondition = 'C.jugend_liga_id = %d AND C.status = \'1\' ORDER BY score DESC, goals_diff DESC, wins DESC, draws DESC, goals DESC, name ASC';
$parameters = $leagueId;
$teams = array();
// shall update league history? DO this only every 10 minutes
$now = $websoccer->getNowAsTimestamp();
