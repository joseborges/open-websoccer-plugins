...
class KuehnLeagueDataService {
	...
	public static function getjugendLeaguesSortedByCountry(WebSoccer $websoccer, DbConnection $db) {
$fromTable = $websoccer->getConfig("db_prefix") . "_jugendliga AS L";
// where
$whereCondition = "1 ORDER BY league_country ASC, league_name ASC";
// select
$columns["L.id"] = "league_id";
...
$columns["L.kurz"] = "league_short";
$columns["L.land"] = "league_country";
$columns["L.picture"] = "picture";
return $db->queryCachedSelect($columns, $fromTable, $whereCondition);
}

public static function getJugendLeagueById(WebSoccer $websoccer, DbConnection $db, $leagueId) {
$fromTable = $websoccer->getConfig("db_prefix") . "_jugendliga AS L";
// where
$whereCondition = "L.id = %d";
$parameters = $leagueId;
