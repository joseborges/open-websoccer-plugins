 ...
 * @author Ingo Hofmann
 */
class KuehnLeagueDetailsModel implements IModel {
	private $_db;
	private $_i18n;
	private $_websoccer;
	...
	public function getTemplateParameters() {
		...
		return array("league" => $league, "leagues" => LeagueDataService::getLeaguesSortedByCountry($this->_websoccer, $this->_db), "juleagues" => KuehnLeagueDataService::getjugendLeaguesSortedByCountry($this->_websoccer, $this->_db));
	}
