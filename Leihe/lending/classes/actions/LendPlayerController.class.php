...
class LendPlayerController implements IActionController {
	...
	//	}
		...
		$this->updatePlayer($player["player_id"], $parameters["fee"], $parameters["dauer"]);
	...
	private function updatePlayer($playerId, $fee, $dauer) {
		
		$columns = array("lending_fee" => $fee, "lending_dauer" => $dauer );
